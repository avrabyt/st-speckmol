...
def vismol(bxi=-10,byi=-10,bzi=-10,bxf=5,byf=5,bzf=5):  
    ...
    mol_view.zoomTo()  
    mol_view.show()
    showmol(mol_view, height = 500,width=800)

from ipywidgets import interact,fixed,IntSlider,embed,widgets, interactive
import ipywidgets
import streamlit.components.v1 as components
cc = interactive(vismol,bxi=ipywidgets.IntSlider(min=-100,max=100, step=1) ,byi=ipywidgets.IntSlider(min=-100,max=100, step=1),
...
components.html(html,width=1200, height=1200)